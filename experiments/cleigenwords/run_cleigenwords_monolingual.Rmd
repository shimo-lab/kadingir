...
```{r}
paths.corpus <- list(en = list(parallel    = "./../corpora/europarl/europarl-v7.es-en.en.tokenized.10000.parallel",
                               monolingual = "./../corpora/europarl/europarl-v7.es-en.en.tokenized.10000.monolingual"))
