...
```{r}
paths.corpus <- list(es = list(parallel    = "./../data/europarl/europarl-v7.merged.es.tokenized.10000"),
                     de = list(parallel    = "./../data/europarl/europarl-v7.merged.de.tokenized.10000"),
                     fr = list(parallel    = "./../data/europarl/europarl-v7.merged.fr.tokenized.10000"),
                     en = list(parallel    = "./../data/europarl/europarl-v7.merged.en.tokenized.10000"))

r <- CLEigenwords(paths.corpus,
                  sizes.vocabulary = c(1000, 1000, 1000, 1000),
                  dim.common = 40,
