...
```{r}
paths.corpus <- list(es = list(parallel    = "./../data/europarl/europarl-v7.merged.es.tokenized"),
                     de = list(parallel    = "./../data/europarl/europarl-v7.merged.de.tokenized"),
                     fr = list(parallel    = "./../data/europarl/europarl-v7.merged.fr.tokenized"),
                     en = list(parallel    = "./../data/europarl/europarl-v7.merged.en.tokenized"))
