...
```{r}
paths.corpus <- list(es = list(parallel    = "./../data/europarl/europarl-v7.es-en.es.tokenized.parallel",
                               monolingual = "./../data/europarl/europarl-v7.es-en.es.tokenized.monolingual"),
                     en = list(parallel    = "./../data/europarl/europarl-v7.es-en.en.tokenized.parallel",
                               monolingual = "./../data/europarl/europarl-v7.es-en.en.tokenized.monolingual"))
