...
```{r}
paths.corpus <- list(es = list(parallel    = "./../data/europarl/europarl-v7.merged.es.tokenized.100000"),
                     de = list(parallel    = "./../data/europarl/europarl-v7.merged.de.tokenized.100000"),
                     fr = list(parallel    = "./../data/europarl/europarl-v7.merged.fr.tokenized.100000"),
                     en = list(parallel    = "./../data/europarl/europarl-v7.merged.en.tokenized.100000"))

r <- CLEigenwords(paths.corpus,
                  sizes.vocabulary = c(10000, 10000, 10000, 10000),
                  dim.common = 40,
...
```{r}
queries <- c(vocab.words1[1:20], vocab.words2[1:20], vocab.words3[1:20], vocab.words4[1:20])
