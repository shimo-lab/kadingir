...
```{r, results = "asis"}
translate.table <- read.csv("translate_table_es-en_es_0121_reduced.csv", sep = ",", as.is = TRUE)[1:100, ]
...
matplot(precision, pch = 1:3)
legend(600, 0.1, legend = colnames(precision), pch = 1:3, col = 1:3)
```