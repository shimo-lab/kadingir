...
```
load("./../res_cleigenwords_0121.Rdata")
write(paste0(r$vocab.words[[1]], collapse = "\n"), "output_vocab_es-en_es_0121.csv")
write(paste0(r$vocab.words[[2]], collapse = "\n"), "output_vocab_es-en_en_0121.csv")
```
...
save(res.cllsa, file = "res_cllsa_0121.Rdata")
load("res_cllsa_0121.Rdata")
...
```{r, results = "asis"}
translate.table <- read.csv("translate_table_es-en_es_0121_reduced.csv", sep = ",", as.is = TRUE)[1:1000 + 5000, ]
