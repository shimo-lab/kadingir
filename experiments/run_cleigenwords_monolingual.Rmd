...
res.cleigenwords <- CLEigenwords(paths.corpus, sizes.vocabulary=c(10000), dim.common=50,
...
TestGoogleTasks(V.en, vocab.words.en, path = "./../test/questions-words.txt", n.cores = 10)
TestWordsim353(V.en, vocab.words.en, path = "./../test/combined.csv")
```
